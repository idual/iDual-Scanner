...
Die passenden Receiver-Apps und Beispiele findest du hier:
...
iDual Scanner nutzt das lokale Netzwerk, um Empfänger zu finden (Bonjour/mDNS) und um Barcodes an einen Zielrechner zu übertragen.
...
Ersetze die Platzhalter-Adresse durch deine Support-Mail:

support@DEINE-DOMAIN.TLD
